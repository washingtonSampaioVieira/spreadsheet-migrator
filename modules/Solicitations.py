...
class Solicitation:
    ...
    def insert_solicitations(self, product_config):
        ...
        solicitations = ex_reader.read_file(formatter.format)
        ...
        for solicitation in solicitations:
            ...
            if solicitation[DatabaseField.CNPJ] != 'nan':
                if solicitation_exists:
                    ...
                    if sucess:
                        ...
                        self.logger.error('There was an error on inserting solicitation %s' % sol_id)
